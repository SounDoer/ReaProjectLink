...
assert(review.publish_revision == 5, "next Publish revision")
...
local resolved = source_review.build({
  current = current,
  previous_snapshot = previous,
  publish_anyway = true,
  identity_decisions = {
...
local moved = source_review.build({
  current = current,
  previous_snapshot = previous,
  publish_anyway = true,
  identity_decisions = { ["item-2"] = { kind = "new" } },
...
local changed = source_review.build({
  current = current,
  previous_snapshot = previous,
  publish_anyway = true,
